...
import eu.riscoss.ram.ahp.AHPConfiguration;
...
public class RAMTest {
	...
	public void run() {
		...
		RiskScenario scenario = ram.createScenario( conf );
		...
		{
			AHPConfiguration ahpConf = new AHPConfiguration();
			
			// TODO User input to set parameters
			ahpConf.inputs.add( new AHPInput() );
			
			ram.apply( ahpConf, scenario );
