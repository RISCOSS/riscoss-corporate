...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "models" because\n';
  ...
  $wnd.__gwt_activeModules['models'] = {
    'moduleName' : 'models',
    'bindings' : function() {
      return {};
    }
 ...
 * "/models.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['models'].superdevmode = true;

  var expectedSuffix = '/models.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + models + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:models';
  var devModeSessionKey = '__gwtDevModeSession:models';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/models/models.nocache.js';
  ...
  $wnd.__gwt_activeModules['models'].canRedirect = true;
  $wnd.__gwt_activeModules['models'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/models?user.agent=' + ua + '&_callback=' + callback;
