...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "rdr" because\n';
 ...
 * "/rdr.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['rdr'].superdevmode = true;

  var expectedSuffix = '/rdr.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + rdr + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:rdr';
  var devModeSessionKey = '__gwtDevModeSession:rdr';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/rdr/rdr.nocache.js';
  ...
  $wnd.__gwt_activeModules['rdr'].canRedirect = true;
  $wnd.__gwt_activeModules['rdr'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/rdr?user.agent=' + ua + '&_callback=' + callback;
