...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "analysis" because\n';
  ...
  $wnd.__gwt_activeModules['analysis'] = {
    'moduleName' : 'analysis',
    'bindings' : function() {
      return {};
    }
 ...
 * "/analysis.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['analysis'].superdevmode = true;

  var expectedSuffix = '/analysis.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + analysis + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:analysis';
  var devModeSessionKey = '__gwtDevModeSession:analysis';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/analysis/analysis.nocache.js';
  ...
  $wnd.__gwt_activeModules['analysis'].canRedirect = true;
  $wnd.__gwt_activeModules['analysis'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/analysis?user.agent=' + ua + '&_callback=' + callback;
