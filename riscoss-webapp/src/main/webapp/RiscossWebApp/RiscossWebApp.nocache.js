...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "RiscossWebApp" because\n';
  ...
  $wnd.__gwt_activeModules['RiscossWebApp'] = {
    'moduleName' : 'RiscossWebApp',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/RiscossWebApp.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['RiscossWebApp'].superdevmode = true;

  var expectedSuffix = '/RiscossWebApp.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + RiscossWebApp + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:RiscossWebApp';
  var devModeSessionKey = '__gwtDevModeSession:RiscossWebApp';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/RiscossWebApp/RiscossWebApp.nocache.js';
  ...
  $wnd.__gwt_activeModules['RiscossWebApp'].canRedirect = true;
  $wnd.__gwt_activeModules['RiscossWebApp'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING RiscossWebApp';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/RiscossWebApp?user.agent=' + ua + '&_callback=' + callback;
